...
public class DressUpManager : TaskManager
{
    ...
    public override void GenerateObjectsInWorld()
    {
        ...
        */
        ...
        Vector3 floorPosition = Vector3.zero;//floor.transform.position + (plane.PlaneThickness * plane.SurfaceNormal);
        ...
        assistantPosition.y = floorPosition.y;//floor.position.y;
